...
{
    [McpServerPrompt(Name = "factorial_prompt"), Description("Calculate the factorial of a number.")]
    public static string FactorialPrompt(int number)
    {
        return $"Calculate the factorial of {number}.";
    }

    [McpServerPrompt(Name = "find_primenumber_prompt"), Description("Find the Prime number between two numbers.")]
